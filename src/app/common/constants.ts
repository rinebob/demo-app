import { ProjectData, SkillData, AngExpRoutes, Board, ColumnColor, ColumnOrder, ExperienceData, NavButtonConfig, SortedTasks, Task, TaskStatus, ButtonMetadata, ComingSoonMetadata, ComingSoonDict, RinebobSite, IconNavBarLink, AppRoutes, GuidedTourDict, GuidedTourMetadata, AuthLevel, ColorSpec, TypographySpec } from "./interfaces";
...
export const ANG_EXP_NAV_BUTTONS:NavButtonConfig[] = [
    ...
    {routerLink: AngExpRoutes.SCROLL, text: 'scroll'},
];
